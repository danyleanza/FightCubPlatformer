...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
		...
		{
			DoJump ();
		} else if (_canDoubleJump && CrossPlatformInputManager.GetButtonDown ("Jump")) // if can double jump and jump button pressed, then allow player to double jump
		{
			DoJump ();
			// disable double jump after double jump
